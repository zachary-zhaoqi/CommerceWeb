...
<section class="error-page">
    <div class="container">
        <div class="col-md-12">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/mall/index.jsp">主页</a></li>
                <li class="breadcrumb-item active">出错啦</li>
            </ol>
        </div>
        <div class="col-sm-10">
            <h1 style="text-align: center">出现错误！</h1><br>
            <h3 style="text-align: center"><%= request.getAttribute("errorMessage") %></h3>
        </div>
    </div>
</section>
